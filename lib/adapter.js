...
export default function FoundationdbAdapter(api, {
	...
	function setDoc(id, metadata, tn) {
		...
		if (typeof metadata.seq === 'string') {
			...
			tn.at(stores.docStore).setVersionstampedValue(id, metadata);
		...
		if (sparseSeq) {
			...
			if (state.sparse != null) {
				...
				return /** @type {import('./types.js').SeqString} */(
					`${readVersion.toString('hex')}0000${state.sparse.seqOffset.toString(16).padStart(4, '0')}`
				);
			}
		}
	...
	const stores = {
		...
		docStore: /** @type {fdb.Subspace<import('./types.js').Id | typeof startOfKeyspace | typeof endOfKeyspace, import('./types.js').Id, import('./types.js').Metadata, import('./types.js').FinalizedMetadata>} */(
