...
import readAsBluffer from './readAsBlobOrBuffer.js';
import prepareAttachmentForStorage from './prepareAttachmentForStorage.js';
import createEmptyBluffer from './createEmptyBlobOrBuffer.js';
...
function LevelPouch(opts, callback) {
	...
	api._allDocs = function (opts, callback) {
		...
		return readLock((opts, callback) => {
            ...
            && readstreamOpts.gte > readstreamOpts.lte)) {
				...
				var throughStream = through((entry, _, next) => {
	...
	api._changes = function (opts) {
		...
		var throughStream = through((data, _, next) => {
